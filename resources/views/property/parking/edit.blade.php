@extends('layouts.app', ['page_title' => "Edit Parking Space"])
            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Edit Parking Space</h3>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('property.parking.update') }}" method="post">

                        <div class="form-group">
                            <label for="location">Parking Location <span class="text-danger">*</span></label>
                            <input type="text" class="form-control {{ $errors->has('location') ? 'is-invalid' : '' }}" name="location" aria-describedby="location" value="{{ $parking->location }}" required>
                            @error('location')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="parking_deposit_amount" aria-describedby="parking_deposit_amount" placeholder="Enter the deposit amount" value="{{ $parking->parking_deposit_amount }}">
                        </div>

                        <div class="form-group">
                            <label for="monthly_fee">Monthly Charge For Parking Space</label>
                            <input type="text" class="form-control" name="monthly_fee" aria-describedby="monthly_fee" placeholder="Enter parking location" value="{{ $parking->monthly_fee }}">
                        </div>
