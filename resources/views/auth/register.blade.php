@extends('layouts.app', ['class' => 'bg-default', 'page_title' => "Register Account"])
                ...
                <div class="card bg-secondary shadow border-0">
                    ...
                    <div class="card-body px-lg-5 py-lg-5">
                        <div class="text-center text-muted mb-5">
                            <span class="text-success">Start your free 14 day trial. <br>No payment method neccessary!</span>
                        </div>
                        <form role="form" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-alternative">
                                    ...
                                    <input id="company_name" type="text" class="form-control form-control-alternative" name="company_name" placeholder="Company Name" required>
                                </div>
                                <small id="company_nameHelp" class="form-text text-muted">If you are a home owner, just write in your first and last name as the company name.</small>
                            </div>
