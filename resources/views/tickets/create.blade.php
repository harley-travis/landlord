@extends('layouts.app', ['page_title' => "Submit a Ticket"])
            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Submit a Ticket</h3>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('tickets.add') }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            @error('subject')
                            <span class='invalid-ticket'>{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <button type="submit" class="btn btn-success shadow">Submit Ticket</button>
