@extends('layouts.app', ['page_title' => "Transaction Details"])
            ...
            <div class="card shadow">
                <div class="card-header border-0">
                    <div class="row align-items-center">
                        <div class="col-8">
                            <h3 class="mb-0">Transaction Details for {{ $tenant->name }}</h3>
                        </div>
                ...
                <div class="card-body">
                    ...
                    <p>Update previous transaction</p>

                    <form action="{{ route('tenants.billing.payment.update') }}" method="post">

                        <div class="form-group">
                            <label for="name">Rent Amount <small class="text-danger pl-2">required</small></label>
                            <input type="text" class="form-control {{ $errors->has('amount_paid') ? 'is-invalid' : '' }}" name="amount_paid" aria-describedby="amount_paid" value="{{ $transaction->amount_paid }}">
                            @error('amount_paid')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="late_fee_amount" aria-describedby="late_fee_amount" value="{{ $transaction->late_fee_amount }}">
                        </div>
